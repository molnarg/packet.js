...
function defineTypedProperty(object, name, desc) {
  ...
  var offset = '__offset_' + name, length = '__length_' + name, type = '__type_' + name
    , prev_offset = '__offset_' + object.__last, prev_length = '__length_' + object.__last

  var buildtime_offset = propertyExpression(object, offset, desc.offset || function() { return this[prev_offset] + this[prev_length] })
  var buildtime_view   = propertyExpression(object, type, desc.view)

  Object.defineProperty(object, name, { get: function() {
    var nested_object = new this[type](this, this[offset] / 8)
  ...
  try {
    var prototype_length = Object.create(buildtime_view.prototype).length * 8
  } catch (e) {
    // There's no buildtime information about the type, or it has no buildtime length property
  }
  propertyExpression(object, length, desc.length || prototype_length || function() { return this[name].length * 8 })
...
function defineNestedProperties(object, name, desc) {
  if (!desc.__view) {
    ...
    desc.__view = function NestedStructure(parent, offset) { Structure.call(this, parent, offset) }
