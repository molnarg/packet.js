...
Structure.defineArrayProperty = function(object, name, desc) {
  var prototype, previous = object.__last
  ...
  if (typeof desc[0] === 'object') {
    ...
    prototype = Structure.create(Structure.prototype, desc[0])

  } else if (typeof desc[1] === 'object') {
    propertyExpression(object, '__items_' + name, desc[0])
    prototype = Structure.create(Structure.prototype, desc[1])
  ...
  Object.defineProperty(object, name, { get: function() {
    ...
    Object.defineProperty(array.__proto__, 'last', { get: function() { return this[this.length - 1] } })

    if (items === 0) return array

    do {
      array.length += 1
      defineItemProperty(array, array.length - 1)
