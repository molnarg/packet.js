...
Buffer.prototype.setUint8  = function(offset, value) { this.writeUInt8(value, offset) }
Buffer.prototype.setUint16 = function(offset, value) { this.writeUInt16BE(value, offset) }
Buffer.prototype.setUint32 = function(offset, value) { this.writeUInt32BE(value, offset) }
...
function declareAccessorFunctions(bitLength) {
  ...
  View.prototype[getName] = function(offset) {
    offset += this.offset
  ...
  View.prototype[setName] = function(offset, value) {
    offset += this.offset
